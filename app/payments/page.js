  ...
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-8 rounded-3xl border border-slate-800 bg-slate-900/80 p-8 shadow-xl shadow-slate-950/50 md:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <div className="mt-6 grid gap-4">
              {paymentHighlights.map((item) => (
                <div key={item.title} className="flex gap-3 rounded-2xl border border-slate-800 bg-slate-900/80 p-4 text-sm text-slate-300">
          ...
          <div className="flex flex-col justify-between gap-6 rounded-3xl border border-slate-700 bg-gradient-to-br from-violet-900/30 via-slate-900/80 to-slate-900 p-6 text-white shadow-lg shadow-slate-950/40">
            <div>
              <p className="text-sm font-semibold text-slate-300">Live ETA</p>
  ...
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <p className="mt-3 text-slate-300">Here’s how we roll out Razorpay across every engagement over the next few days.</p>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {integrationTimeline.map((item) => (
            <div key={item.phase} className="flex h-full flex-col justify-between rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-sm">
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-slate-400">{item.window}</p>
    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-slate-300">Each digital payment step is backed by documentation workflows so your auditors, procurement teams and customers stay aligned.</p>
        </div>
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {supportBlocks.map((block) => (
            <div key={block.title} className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 text-white shadow-lg shadow-slate-950/40">
...
function ContactCta() {
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-8 text-slate-200 shadow-xl shadow-slate-950/40 md:flex md:items-center md:justify-between md:gap-10">
          <div>
          ...
          <div className="mt-6 flex gap-4 md:mt-0">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-slate-600 px-4 py-2 text-sm font-semibold text-slate-300 transition hover:border-slate-500 hover:text-white"
            >
              Call us
