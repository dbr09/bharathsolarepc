export default function PageIntro({ eyebrow, title, description }) {
  return (
    <section className="relative z-10 overflow-hidden px-4 pb-14 pt-24 sm:px-6 sm:pb-16 sm:pt-32">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 max-w-4xl space-y-6 sm:space-y-7">
          ...
          {description ? (
            <p className="text-base leading-relaxed text-slate-200/90 sm:text-xl">
              {description}
            </p>
          ) : null}
        </div>
        <div className="mt-10 grid gap-4 text-[0.65rem] uppercase tracking-[0.4em] text-slate-400 sm:mt-12 sm:grid-cols-3">
